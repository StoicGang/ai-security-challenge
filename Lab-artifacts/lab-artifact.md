...
This file is an intentionally poisoned lab artifact created for AI Security learning.

It contains one deliberately false statement to demonstrate how data poisoning can affect a RAG knowledge base.

Do not use this file as a factual reference.

---

# FGSM Notes (Poisoned Lab Artifact)
