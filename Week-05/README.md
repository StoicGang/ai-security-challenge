...
- [x] Week-05-Learning.md filled in (aggregate reflection)
...
| DONE | [Day 031](Day-031/) | Poisoning Impact - Hands-On | n/a |
...
## Weekly Quiz
- [x] Map each Week 5 attack to training-time vs. inference-time.
- [x] What is the difference between membership inference and model extraction?
...
> *Note* : Look at the [learning file](Week-05-Learning.md)
---
